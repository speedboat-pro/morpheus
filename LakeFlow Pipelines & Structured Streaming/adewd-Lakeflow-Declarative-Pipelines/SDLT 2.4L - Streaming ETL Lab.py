...
# MAGIC
# MAGIC This notebook programmatically generates and triggers an update of a Lakeflow Declarative pipeline that consists of the following notebooks:
# MAGIC
...
# MAGIC |[Streaming ETL]($./Pipeline/SDLT 2.4.1L - Streaming ETL Lab)|
# MAGIC
...
# MAGIC %md
# MAGIC #### REQUIRED!!!: Make sure to complete the lab in the Lakeflow Declarative pipeline notebook linked above ([Streaming ETL Lab]($./Pipeline/SDLT 2.4.1L - Streaming ETL Lab)) before running this pipeline.
# MAGIC
# MAGIC After editing the final notebook, run the cell below to start the pipeline.
# MAGIC
# MAGIC **NOTE:** If prompted to enable the new Lakeflow Declarative Pipeline editor, you can choose to enable it if you're already familiar with it or if you'd like to explore the new interface.
...
# MAGIC %md
# MAGIC ##### 📌 NOTE: Please navigate to the Jobs and Pipelines tab and ensure the pipeline has completed successfully before running further cells.
